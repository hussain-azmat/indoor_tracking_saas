import React, { forwardRef, Fragment, useState, useCallback } from "react";
...
const EmojiTextarea = forwardRef((props, ref) => {
  const {
    theme,
    classes,
    rightContent,
        ...
        >
          <TextField
            ...
            InputProps={{
              ...
              inputRef: ref // Forwarding the ref to the TextField
            }}
          />
